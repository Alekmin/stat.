...
Employee employee1 = new Employee("Natalia","Nowak",26);
Employee employee2 = new Employee("Aleksander","Kowalski",42);
Employee employee3 = new Employee("Krzysztof", "Walaszek", 32);
